...
2. Make sure there are files under the `NtUtilsUI\NtUtils` directory, otherwise, you didn't clone the submodules.
...
4. Open `NtUtilsUI\DesignTime\NtUtilsUI.DesignTime.dproj` in the IDE and click `Install` on the project to register it as a design-time package.    
![Install](https://user-images.githubusercontent.com/30962924/180660721-50fe47dc-039d-40cf-a190-c99f91ac0e2d.png)
5. Similarly, open `NtUtilsUI\VclEx\DesignTime\VclExtension.dproj` and click `Install`.
