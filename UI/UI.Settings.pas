...
const
  ColumsInfo: array [TTokenStringClass] of TColumnInfo = (
    ...
    (Caption: 'Handle Count';             Width: 100; Alignment: taLeftJustify),
    (Caption: 'Paged Pool Charge';        Width: 100; Alignment: taLeftJustify),
    (Caption: 'Non-Paged Pool Charge';    Width: 100; Alignment: taLeftJustify),
    (Caption: 'Kernel Address';           Width: 100; Alignment: taLeftJustify),
    (Caption: 'Creator';                  Width: 100; Alignment: taLeftJustify),
    (Caption: 'User Name';                Width: 170; Alignment: taLeftJustify),
    (Caption: 'Groups';                   Width: 100; Alignment: taLeftJustify),
    (Caption: 'Enabled Groups';           Width: 100; Alignment: taLeftJustify),
    (Caption: 'Privileges';               Width: 100; Alignment: taLeftJustify),
    (Caption: 'Enabled Privileges';       Width: 100; Alignment: taLeftJustify),
    ...
    (Caption: 'Logon SID';                Width: 100; Alignment: taLeftJustify),
